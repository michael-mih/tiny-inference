...
\author{\IEEEauthorblockN{Michael Mihaley}
...
Measurements were collected on a single NVIDIA Tesla T4 GPU with 16 GB of memory, CUDA 12.4, Linux, and Python 3.10.15. The final before/after comparison came from the local W\&B run \texttt{optimized-vs-base} on May 7, 2026. Both tests used the same model, prompt, warmup count, measured-run count, and \texttt{max\_new\_tokens=256}.
...
We used OpenAI Codex for code cleanup, README restructuring, and fixing grammatical errors in this LaTeX report. 
